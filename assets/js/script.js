...
if (/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
    // some code..
    window.location.replace("https://wip.camp/m");
}
...
$(document).keydown(function (e) {
    ...
    $(".easter .container img").each(function (i, img) {
        $(img).css("margin-top", "20px");
    });
    $(".easter .container img").each(function (i, img) {
        $(img).css("margin-left", "20px");
    });
    $(".easter .container .slogan").each(function (i, img) {
        $(img).css("margin-left", "20px");
    });
});
...
console.log('%cStop! your ACTION.','font-size: 50px; color:red; background:yellow');
console.log('%cPlease respect my code.', 'background: #222; color:lightgreen; font-size: 30px ');
console.log('%cWIP Camp #8 Developer Team.', 'background: #222; color: #fff; font-size: 30px ');